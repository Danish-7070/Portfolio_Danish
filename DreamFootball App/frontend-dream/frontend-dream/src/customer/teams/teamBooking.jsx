        ...
        <div>
            ...
            <div className="p-20 max-sm:p-5 max-sm:pt-20 mt-10 bg-custom text-white min-h-screen">
                <div className="flex justify-between items-center">
                    <h1 className="text-3xl font-extrabold text-primary">Teams Bookings</h1>
                </div>
                ...
                <div className="mt-10 bg-customDark2 p-6 rounded-lg shadow-md">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2">
                            <label htmlFor="teamRequired" className="text-white font-semibold">
                                Team Required?
                            </label>
                            <div className="flex items-center">
                                <input
                                    ...
                                    className="w-6 h-6 accent-[#9ce37d] cursor-pointer"
                                />
                        ...
                        {bookingHistoryData.map((booking) => (
                            ...
                            >
                                ...
                                <p className="font-bold">Price:
                                    ...
                                    {/* <span>PKR &nbsp;
                                        {(booking.withLights) ? (
                                            booking.ground?.rateWithLights ? booking.ground?.rateWithLights * Number(booking.bookingDuration) : 'N/A or 0'
                                        ) : (
